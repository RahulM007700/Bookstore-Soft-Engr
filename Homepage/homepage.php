...
<body>
  ...
  <div class="modal fade" id="pwVerifiyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header text-center">
          <h4 class="modal-title w-100 font-weight-bold">Verfication Code</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form>
          <div class="modal-body mx-3">
            <div class="md-form mb-5">
              <i class="fas fa-envelope prefix grey-text"></i>
              <label data-error="wrong" data-success="right" for="email-login">Please enter verification code sent to your email.</label>
              <input type="verifycode" placeholder="Enter Verification" name="verification" id="verification" class="form-control validate" required />
            </div>
            <div class="modal-footer d-flex justify-content-center">
              <button type="submit" class="btn btn-default" id="resetbtn" onclick="">Submit Code</button>
              <br>
            </div>
        </form>
      </div>
          ...
          <div class="col-md-4 mt-5 footer-links" style="visibility: visible; left:80px;">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <p style="text-align:left;color:black;"><a href="../Homepage/AboutUs.php" style="color:black; text-decoration: none;">About Us</a></p>
                <p style="text-align:left;color:black;"><a href="../Homepage/homepage.php" style="color:black; text-decoration: none;" data-toggle="modal" data-target="#contactModal">Contact</a></p>
              </div>
              <div class="col-md-6">
                <p style="text-align:left;color:black;"><a href="../Homepage/homepage.php" style="color:black; text-decoration: none;" id="contactTab" data-toggle="modal" data-target="#loginModal">Login</a></p>
                <p style="text-align:left;color:black;"><a href="../Homepage/homepage.php" style="color:black; text-decoration: none;" id="contactTab" data-toggle="modal" data-target="#registrationModal">Registration</a></p>
              </div>
            </div>
          </div>
        </div>
