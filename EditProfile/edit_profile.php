      ...
      <div class="editProfileContainer">
        ...
        <form id="editProfileForm" action="EditUserProfile.php" method="POST">
          <div class="profile tabShow">
            ...
            <button id="updateProfileButton" onclick="changeToTextPersonal()" class="btn" type="button">
              Update
            </button>
          </div>
          <div class="payment tabShow">
            ...
            <input
              ...
              type="text"
              class="input"
              value='<?php echo $_SESSION['ExpDate'];?>'
              maxlength="5"
              readonly="true"
            />
            <p></p>
            ...
            <button id="updatePaymentButton" onclick="changeToTextPayment()" class="btn" type="button">
              Update
            </button>
          </div>
          <div class="address tabShow">
            ...
            <button id="updateAddressButton" onclick="changeToTextAddress()" class="btn" type="button">
              Update
            </button>
            <button type="submit">SubmitChanges</button>
          </div>
        </form>
      </div>
    </div>
